...
CREATE TABLE `personalizacao` (
    ...
    `valor_opcao` DOUBLE NOT NULL,
    `boloId` INTEGER NOT NULL,

    INDEX `personalizacao_boloId_fkey`(`boloId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `personalizacao` ADD CONSTRAINT `personalizacao_boloId_fkey` FOREIGN KEY (`boloId`) REFERENCES `bolo`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
